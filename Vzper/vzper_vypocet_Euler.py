from Vzper_fce_obecne.vzper_fce import reduk_delka, stihlost
from Vzper_euler.vzper_fce_krit_sila import vzper
from Vzper_euler.vzper_fce_delka_tyce import vzper_delka
